...
const LineHeight = ({index,setThePionSelected,ThePionSelected,setMagicBordersPosibility,colorTurn,setColorTurn,whitePackage,setwhitePackage,blackPackage,setBlackPackage,setIsInChessMate}) => {
